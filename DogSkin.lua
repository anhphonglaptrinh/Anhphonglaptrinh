...
-- Gốc: tạo một part làm neo cho mô hình (gắn trực tiếp vào nhân vật)
local core = makePart("Core", Vector3.new(1,1,1), Color3.new(1,1,1), hrp.Position)
core.Transparency = 1
core.CanCollide = false

-- Gắn core vào HumanoidRootPart
local weld = Instance.new("WeldConstraint", core)
weld.Part0 = core
weld.Part1 = hrp

-- Tạo thân + đầu + đuôi
local body = makePart("Body", Vector3.new(4, 2, 6), Color3.fromRGB(120, 80, 50), core.Position)
local head = makePart("Head", Vector3.new(2, 2, 2), Color3.fromRGB(140, 90, 60), core.Position + Vector3.new(0, 1, -3))
